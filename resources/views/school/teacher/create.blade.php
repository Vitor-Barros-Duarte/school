...
<form action="{{route('teacher.store')}}" method="POST">
    ...
    <div class="form-group">
        <label for="name_teacher">Nome completo</label>
        <input type="text"  required="required" name="name_teacher" class="form-control" placeholder="Nome" aria-describedby="basic-addon1">
        </div>
        <div class="row">
            <div class="col-md-6">
            <div class="form-group">
